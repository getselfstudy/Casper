!(function(a) {
    ...
    function h(a) {
        function b(d, e, f, g) {
            var h = c(a[d], a, e);
            if (h.type === "throw") g(h.arg);
            else {
                var i = h.arg,
                    j = i.value;
                return j && typeof j === "object" && q.call(j, "__await")
    ...
    function i(a, b, d) {
        ...
        return function(f, g) {
            ...
            for (d.method = f, d.arg = g; ; ) {
                ...
                elsed.method === "return" && d.abrupt("return", d.arg);
                e = "executing";
                var k = c(a, b, d);
                if (k.type === "normal") {
                    if (
                        ((e = d.done ? "completed" : "suspendedYield"),
                        k.arg === x)
                    )
                        continue;
    ...
    function j(a, b) {
        ...
        if (e.type === "throw")
            return (
                (b.method = "throw"), (b.arg = e.arg), (b.delegate = null), x
            );
        var f = e.arg;
        if (!f)
            return (
    ...
    (e.prototype = B.constructor = f),
        ...
        (w.isGeneratorFunction = function(a) {
            ...
            return (
                !!b &&
                (b === e || (b.displayName || b.name) === "GeneratorFunction")
            );
        }),
        (w.mark = function(a) {
            return (
        ...
        (m.prototype = {
            ...
            abrupt: function(a, b) {
                for (var c, d = this.tryEntries.length - 1; d >= 0; --d)
                    if (
                        ((c = this.tryEntries[d]),
                        c.tryLoc <= this.prev &&
                            q.call(c, "finallyLoc") &&
            ...
            complete: function(a, b) {
                ...
                returna.type === "break" || a.type === "continue"
                    ? (this.next = a.arg)
                    : a.type === "return"
            ...
            finish: function(a) {
                for (var b, c = this.tryEntries.length - 1; c >= 0; --c)
